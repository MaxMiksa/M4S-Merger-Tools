...
- 🎬 **视频片段合并**：多个 M4S 视频片段 ➡️ 一个完整的视频文件
- 🎵 **音频片段合并**：多个 M4S 音频片段 ➡️ 一个完整的音频文件
- 🎞️ **音视频混流**：多个 M4S 视频和音频文件 ➡️ 一个完整的 mp4 文件 (同时有画面和声音)
- 🚀 **一键处理**：全流程自动化！包括环境配置和下载、异常提示和解决、音视频合并和混流
- 💻 **图形界面**：拒绝CMD命令行带来困扰！友好的可视化操作界面，点击即用。
- 🌐 **个性化界面**：软件界面支持切换中文或英语，支持切换浅色或深色显示模式
- 📝 **实时日志**：显示处理进度和日志信息
