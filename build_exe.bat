...
echo ========================================================
echo.
echo 可执行文件位置: dist\M4S Merger Tools v1.3.0.exe
echo Executable location: dist\M4S Merger Tools v1.3.0.exe
echo.
